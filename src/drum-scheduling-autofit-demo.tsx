...
import { AutofitUtils, InstrumentFactories, Project } from "@opendaw/studio-core";
...
/**
 * Drum Scheduling Demo with AudioFit Mode
 * This version uses AudioFit playback mode to demonstrate issues with short audio samples
 */
const App: React.FC = () => {
          ...
          drumSamples.forEach((sample, index) => {
            ...
            positions.forEach((position, clipIndex) => {
              const regionBox = AudioRegionBox.create(boxGraph, UUID.generate(), box => {
                ...
                box.playback.setValue(AudioPlayback.AudioFit); // AudioFit: demonstrates issue with short samples
      ...
      <Container size="3" px="4" py="8">
        <Flex direction="column" gap="6" style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <Callout.Root color="orange" style={{ width: "100%" }}>
            <Callout.Text>
              <strong>Note:</strong> This demo uses AudioFit playback mode with AutofitUtils.changeBpm().
            </Callout.Text>
          </Callout.Root>
