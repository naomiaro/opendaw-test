...
- **No origin naming:** committed text and upstream postings never name the candidate build's origin ("a candidate-fix build was verified locally" is the ceiling). No "Moises", no fork/vendor names, anywhere.
