...
- [Advanced: Region Splicing & Comp Lanes](#advanced-region-splicing--comp-lanes)
  - [What Works](#what-works)
  - [Audio Editing Fundamentals: Zero Crossings](#audio-editing-fundamentals-zero-crossings)
  - [SDK Voice Pop Issue](#sdk-voice-pop-issue)
  - [Workaround: Volume Automation Crossfades](#workaround-volume-automation-crossfades)
  - [Additional Findings](#additional-findings)
  - [Fade Experiments (Web Audio)](#fade-experiments-web-audio)
  - [Files](#files)
  - [Voice Fade Details (from SDK source)](#voice-fade-details-from-sdk-source)
